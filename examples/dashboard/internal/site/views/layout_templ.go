...
func DashboardLayout(data LayoutData, body t.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = ui8layout.Shell(ui8layout.ShellProps{
			...
			HeadExtra:      headExtra(),
			HeaderExtra:    nil,
			HeaderTrailing: partials.AccountMenu(data.CurrentEmail, data.AccountSignOutText, data.LanguageToggle),
