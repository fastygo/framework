...
- `func RequestIDMiddleware() Middleware`
  - если header присутствует — пробрасывает его как есть; иначе генерирует свежий RFC 4122 UUID v4 (через `crypto/rand`, без внешних зависимостей) и пишет его и в контекст запроса, и в response-заголовок.
